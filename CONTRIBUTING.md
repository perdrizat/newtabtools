...
- [`webextension/lib/platform.js`](webextension/lib/platform.js): The browser-capability seam (permissions/action/menus/i18n wrappers, the dual-scope-global accessor) — the file a future Chrome port forks.
...
- [`PAGE_MODULES.md`](PAGE_MODULES.md): The working plan for the next arc (page scripts as ES modules).
