...
- Do not introduce a second test framework, second mocking library, or a Chromium target. Cross-browser support is a deliberate, tracked decision (see [`CONTRIBUTING.md`](CONTRIBUTING.md) "Decisions of record" and the Chrome-port tracking issue); raise it as a question, do not silently add it.
